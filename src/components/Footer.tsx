        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-8 mb-12">
          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-center w-full">
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 mb-6">
              <Link href="#books" className="text-gray-300 hover:text-[#e31e24] text-sm transition">Books</Link>
              <Link href="#software" className="text-gray-300 hover:text-[#e31e24] text-sm transition">Software</Link>
              <Link href="#courses" className="text-gray-300 hover:text-[#e31e24] text-sm transition">Courses</Link>
              <Link href="#articles" className="text-gray-300 hover:text-[#e31e24] text-sm transition">Learning Articles</Link>
              <Link href="#about" className="text-gray-300 hover:text-[#e31e24] text-sm transition">About</Link>
              <Link href="#contact" className="text-gray-300 hover:text-[#e31e24] text-sm transition">Contact</Link>
            </div>
          ...
          <div className="lg:w-1/4 flex flex-col items-start lg:items-end w-full">
            ...
            <div className="flex gap-3">
              {/* Facebook */}
              <a href="#" className="w-8 h-8 rounded-full border border-gray-600 flex items-center justify-center text-gray-400 hover:text-white hover:border-[#e31e24] hover:bg-[#e31e24] transition">
